# Анализ API Secure-Processor Pay: Получение истории платежей клиента

## Краткое описание
Данный отчет содержит детальный анализ API Secure-Processor Payment Gateway для получения истории платежей клиента в веб-приложении. Документ охватывает эндпоинты, методы аутентификации, пагинацию, обработку ошибок и использование вебхуков.
...
**URL:** `https://backoffice.secure-processorpay.com/api/reports`  
**HTTP-метод:** `POST`  
**Ссылка на документацию:** https://docs.secure-processorpay.com/en/payment_management/reports/reports_shop/
...
**Ссылка на документацию:** https://docs.secure-processorpay.com/en/payment_management/reports/paginated_report/
...
**Как получить:**
Учетные данные доступны в личном кабинете Secure-Processor Payment Gateway (back office).

**Ссылка на документацию:** https://docs.secure-processorpay.com/en/using_api/shop_id_and_secret_key/
...
**Ссылка на статусы транзакций:** https://docs.secure-processorpay.com/en/integration/api_for_card_payments/transaction_statuses/
...
**Ссылка на платежные методы:** https://docs.secure-processorpay.com/en/payment_methods/
  ...
  "transactions": [
    {
      ...
      "receipt_url": "https://backoffice.secure-processorpay.com/customer/transactions/dd6ee60c-d30a-4348-b84c-86a4ef1a137d/receipt"
    }
  ]
}
```
...
**Ссылка на коды ошибок:** https://docs.secure-processorpay.com/en/using_api/api_v3_and_api_v2_error_codes/
...
**Статус:** Официальная документация Secure-Processor Pay не предоставляет конкретных численных значений rate limits.

**Рекомендация:** Свяжитесь с технической поддержкой Secure-Processor Payment Gateway для получения точной информации об ограничениях для вашего аккаунта.
...
**Ссылка на документацию:** https://docs.secure-processorpay.com/en/using_api/webhooks/
...
```json
{
  "notification_url": "https://your-domain.com/api/webhooks/secure-processor",
  ...
}
```
...
**Алгоритм проверки:**
1. Получите публичный RSA-ключ из back office Secure-Processor
...
Если ваш сервер не ответил или вернул ошибку, Secure-Processor выполнит повторные попытки:
...
1. Войдите в back office Secure-Processor Payment Gateway
...
3. Формируйте POST-запрос к `https://backoffice.secure-processorpay.com/api/reports`
...
1. Создайте эндпоинт для приема вебхуков: `/api/webhooks/secure-processor`
...
```http
POST https://backoffice.secure-processorpay.com/api/reports
Content-Type: application/json
X-Api-Version: 2
...
```http
POST https://your-domain.com/api/webhooks/secure-processor
Content-Type: application/json
...
Secure-Processor Pay поддерживает тестовый режим (test mode) для безопасного тестирования интеграции.

**Ссылка на документацию:** https://docs.secure-processorpay.com/en/using_api/test_mode/

**Тестовые данные карт:** https://docs.secure-processorpay.com/en/integration/api_for_card_payments/test_card_data/
...
1. **Главная страница документации:**  
   https://docs.secure-processorpay.com/

2. **Отчеты для магазинов (Reports for shops):**  
   https://docs.secure-processorpay.com/en/payment_management/reports/reports_shop/

3. **API постраничных отчетов (Paginated reports):**  
   https://docs.secure-processorpay.com/en/payment_management/reports/paginated_report/

4. **Webhook-уведомления:**  
   https://docs.secure-processorpay.com/en/using_api/webhooks/

5. **Shop ID и Secret Key:**  
   https://docs.secure-processorpay.com/en/using_api/shop_id_and_secret_key/

6. **Статусы транзакций:**  
   https://docs.secure-processorpay.com/en/integration/api_for_card_payments/transaction_statuses/

7. **Типы транзакций:**  
   https://docs.secure-processorpay.com/en/integration/api_for_card_payments/transaction_types/

8. **Коды ошибок API:**  
   https://docs.secure-processorpay.com/en/using_api/api_v3_and_api_v2_error_codes/

9. **Тестовый режим:**  
   https://docs.secure-processorpay.com/en/using_api/test_mode/

10. **Тестовые данные карт:**  
    https://docs.secure-processorpay.com/en/integration/api_for_card_payments/test_card_data/

### Дополнительные материалы

11. **Платежные методы:**  
    https://docs.secure-processorpay.com/en/payment_methods/

12. **Проверка транзакций:**  
    https://docs.secure-processorpay.com/en/using_api/transaction_verification/

13. **Идемпотентные запросы:**  
    https://docs.secure-processorpay.com/en/using_api/idempotent_requests/

14. **Postman-коллекция:**  
    https://docs.secure-processorpay.com/en/using_api/postman_collection/

15. **Tokenization service:**  
    https://docs.secure-processorpay.com/en/additional_services/tokenization_service/
...
1. **Для получения истории платежей используйте:**
   - Эндпоинт: `https://backoffice.secure-processorpay.com/api/reports`
   - Метод: POST
...
**Версия API:** 2  
**Источник документации:** https://docs.secure-processorpay.com/
