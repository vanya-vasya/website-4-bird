...
const config = {
  ...
  apiUrl: process.env.SECURE_PROCESSOR_API_URL || 'https://checkout.secure-processor.com',
...
function makeRequest(requestData) {
  return new Promise((resolve, reject) => {
    ...
    const options = {
      hostname: 'checkout.secure-processor.com',
      port: 443,
  ...
  try {
    ...
    const validations = [
      ...
      },
      {
        ...
        pass: response.body.checkout?.redirect_url?.startsWith('https://checkout.secure-processor.com'),
        expected: 'starts with https://checkout.secure-processor.com',
